...
class PaymentGroupTest < ActiveSupport::TestCase
  ...
  test "should create a payment_group" do
    assert_not_nil @payment_group.id
  end

  test "should have associated services" do
    assert_not_nil @payment_group.services.count
  end
